...
public class CheckersFrame extends JFrame implements MouseListener, MouseMotionListener, KeyListener {
    ...
    public CheckersFrame() {
        ...
        URL url = this.getClass().getResource("/assets/Kevin MacLeod_ Aces High.wav");
    ...
    public void createMenu() {
        ...
        JMenu levels = new JMenu("Difficulties");
        menuBar.add(levels);
        ButtonGroup levelsGroup = new ButtonGroup(); // group for radio buttons
        
        JRadioButtonMenuItem hardLevel = new JRadioButtonMenuItem("Hard Level");
        ...
        JRadioButtonMenuItem mediumLevel = new JRadioButtonMenuItem("Medium Level");
        ...
        JRadioButtonMenuItem easyLevel = new JRadioButtonMenuItem("Easy Level");
...
/*      Comments : -
        ...
        1. The import statements include the necessary classes from the "checkers" package as well as several classes from the standard Java library.

        2. The class CheckersFrame extends JFrame and implements several interfaces including MouseListener, MouseMotionListener, and KeyListener.

        3. The CheckersFrame class contains a CheckersPanel object and several instance variables that are used to keep track of the state of the game.

        4. The boardHistory ArrayList is used to keep track of the history of moves made during the game.

        5. The userColor and computerColor variables are used to keep track of which player is which color.

        6. The from variable is used to keep track of the source of a move,
           and the thinkDepth variable is used to determine how many moves ahead the computer should consider when making a move.

        7. The menuBar variable is used to create a menu bar at the top of the frame.

        8. The createMenu method is used to populate the menu bar with various menu items,
           including radio buttons to select the algorithm and difficulty of the game.

        9. The main method creates a new instance of the CheckersFrame class and sets it visible.
           It also plays music if the playMusic variable is set to true.
